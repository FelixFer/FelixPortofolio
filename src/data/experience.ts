...
export const experiences: Experience[] = [
  {
    ...
    bullets: [
      ...
      'Led frontend development activities and coordinated project delivery across frontend team members.',
      'Collaborated with UI/UX, backend, and QA teams to ensure seamless feature implementation and release.',
      'Participated in sprint planning, estimation, backlog refinement, and project coordination meetings.',
      'Improved code quality through code reviews, reusable components, and frontend architecture enhancements.',
    ],
